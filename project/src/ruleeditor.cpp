...
void RuleEditor::bringRuleToScreen(QString name) {
    ...
    setManagedByGlobal(name, globalRule.targetRule_display_value, ui->lbl_by_global_rule_display_value, ui->txt_fields_display_value,
                       ui->btn_variables_disp_value);
    ...
    setManagedByGlobal(name, globalRule.targetRule_manufacturer, ui->lbl_by_global_rule_manufacturer, ui->txt_fields_manufacturer,
                       ui->btn_variables_manufacturer);
...
void RuleEditor::showVariableWin() {
    ...
    MainWindow::insertStandardVariablesToMap(variables_lcl, footprint, reference, ruleName, mpn, manufacturer, description, OctoFootprint, OctoFootprintMetric);
