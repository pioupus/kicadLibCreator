...
void drawText(QPainter &painter, QPointF p, TextDirection textDirection,
              KicadSymbolFieldJustify_t text_hjustify,
              KicadSymbolFieldJustify_t text_vjustify, TextStyle textStyle,
              int textSize, const QString &text) {
...
void RenderArea::paintEvent(QPaintEvent * /* event */) {
  ...
  for (KICADLibSchematicDrawElement &da : drawElements) {
    ...
    case DrawType::arc: {
      ...
      if (((start_deg < 90) && (end_deg > 270)) ||
          ((start_deg > 270) && (end_deg < 90))) {
        if (span_deg < 0) {
    ...
    case DrawType::pin: {
      ...
      if ((da.name != "~") && (drawPinName)) {
        drawText(painter, points[2], textDirection, text_hjustify,
                 text_vjustify, TextStyle::normal, TEXTSIZE, da.name);
      }
    } break;
    ...
    case DrawType::text: {
      ...
      drawText(painter, p + centerPoint, da.textDirection, da.text_hjustify,
               da.text_vjustify, da.textStyle, da.textSize, da.text);
