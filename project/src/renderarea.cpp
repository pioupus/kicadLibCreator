...
void drawText(QPainter & painter, QPointF p, TextDirection textDirection,KicadSymbolFieldJustify_t text_hjustify,
KicadSymbolFieldJustify_t text_vjustify,  TextStyle textStyle,int textSize,
              const QString & text)
{
